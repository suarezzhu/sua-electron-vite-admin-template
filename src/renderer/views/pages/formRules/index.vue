...
// 引入组件
const FormRulesOne = defineAsyncComponent(() => import('@renderer/views/pages/formRules/component/formRulesOne.vue'));
const FormRulesTwo = defineAsyncComponent(() => import('@renderer/views/pages/formRules/component/formRulesTwo.vue'));
const FormRulesThree = defineAsyncComponent(() => import('@renderer/views/pages/formRules/component/formRulesThree.vue'));
