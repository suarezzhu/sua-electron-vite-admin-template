...
// 引入组件
const Table = defineAsyncComponent(() => import('@renderer/components/table/index.vue'));
const TableSearch = defineAsyncComponent(() => import('@renderer/views/make/tableDemo/search.vue'));
