...
import { auth, auths, authAll } from '@renderer/utils/authFunction';

// 引入组件
const LimitsFrontEndPage = defineAsyncComponent(() => import('@renderer/views/limits/frontEnd/page/index.vue'));
const Auth = defineAsyncComponent(() => import('@renderer/components/auth/auth.vue'));
const Auths = defineAsyncComponent(() => import('@renderer/components/auth/auths.vue'));
const AuthAll = defineAsyncComponent(() => import('@renderer/components/auth/authAll.vue'));
