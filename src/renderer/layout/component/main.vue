...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('@renderer/layout/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('@renderer/layout/footer/index.vue'));
