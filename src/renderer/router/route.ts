 ...
 * @description 各字段请查看 `@renderer/views/system/menu/component/addMenu.vue 下的 ruleForm`
 * @returns 返回路由菜单数据
 */
export const dynamicRoutes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                path: '/movie',
                name: 'movie',
                component: () => import('@renderer/views/movie/index.vue'),
                meta: {
                ...
                children: [
                    {
                        path: '/document/home',
                        name: 'documentHome',
                        component: () => import('@renderer/views/document/home.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/document/edit',
                        name: 'documentEdit',
                        component: () => import('@renderer/views/document/edit.vue'),
                        meta: {
...

            {
                ...
                children: [
                    ...
                    },
                    {
                        path: '/system/dept',
                        name: 'systemDept',
                        component: () => import('@renderer/views/system/dept/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/system/dic',
                        name: 'systemDic',
                        component: () => import('@renderer/views/system/dic/index.vue'),
                        meta: {
                        ...
                        children: [
                            {
                                ...
                                component: () => import('@renderer/views/limits/frontEnd/page/index.vue'),
                                meta: {
                            ...
                            },
                            {
                                ...
                                component: () => import('@renderer/views/limits/frontEnd/btn/index.vue'),
                                meta: {
                        ...
                        children: [
                            {
                                ...
                                component: () => import('@renderer/views/limits/backEnd/page/index.vue'),
                                meta: {
            ...
            },
            {
                ...
                children: [
                        ...
                        children: [
                            {
                                ...
                                name: 'menu11',
                                component: () => import('@renderer/views/menu/menu1/menu11/index.vue'),
                                meta: {
                                ...
                                children: [
                                    {
                                        ...
                                        name: 'menu121',
                                        component: () => import('@renderer/views/menu/menu1/menu12/menu121/index.vue'),
                                        meta: {
                                    ...
                                    },
                                    {
                                        ...
                                        name: 'menu122',
                                        component: () => import('@renderer/views/menu/menu1/menu12/menu122/index.vue'),
                                        meta: {
                            ...
                            },
                            {
                                ...
                                name: 'menu13',
                                component: () => import('@renderer/views/menu/menu1/menu13/index.vue'),
                                meta: {
                    ...
                    },
                    {
                        path: '/menu/menu2',
                        name: 'menu2',
                        component: () => import('@renderer/views/menu/menu2/index.vue'),
                        meta: {
                ...
                children: [
                    {
                        path: '/fun/tagsView',
                        name: 'funTagsView',
                        component: () => import('@renderer/views/fun/tagsView/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/countup',
                        name: 'funCountup',
                        component: () => import('@renderer/views/fun/countup/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/wangEditor',
                        name: 'funWangEditor',
                        component: () => import('@renderer/views/fun/wangEditor/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/cropper',
                        name: 'funCropper',
                        component: () => import('@renderer/views/fun/cropper/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/qrcode',
                        name: 'funQrcode',
                        component: () => import('@renderer/views/fun/qrcode/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/echartsMap',
                        name: 'funEchartsMap',
                        component: () => import('@renderer/views/fun/echartsMap/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/printJs',
                        name: 'funPrintJs',
                        component: () => import('@renderer/views/fun/printJs/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/clipboard',
                        name: 'funClipboard',
                        component: () => import('@renderer/views/fun/clipboard/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/gridLayout',
                        name: 'funGridLayout',
                        component: () => import('@renderer/views/fun/gridLayout/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/fun/splitpanes',
                        name: 'funSplitpanes',
                        component: () => import('@renderer/views/fun/splitpanes/index.vue'),
                        meta: {
                ...
                children: [
                    {
                        ...
                        name: 'pagesFiltering',
                        component: () => import('@renderer/views/pages/filtering/index.vue'),
                        meta: {
                        ...
                        children: [
                            {
                                ...
                                component: () => import('@renderer/views/pages/filtering/details.vue'),
                                meta: {
                    ...
                    },
                    {
                        ...
                        component: () => import('@renderer/views/pages/filtering/details1.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/iocnfont',
                        name: 'pagesIocnfont',
                        component: () => import('@renderer/views/pages/iocnfont/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/element',
                        name: 'pagesElement',
                        component: () => import('@renderer/views/pages/element/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/awesome',
                        name: 'pagesAwesome',
                        component: () => import('@renderer/views/pages/awesome/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'pagesFormAdapt',
                        component: () => import('@renderer/views/pages/formAdapt/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () => import('@renderer/views/pages/tableRules/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/formI18n',
                        name: 'pagesFormI18n',
                        component: () => import('@renderer/views/pages/formI18n/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'pagesFormRules',
                        component: () => import('@renderer/views/pages/formRules/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'pagesListAdapt',
                        component: () => import('@renderer/views/pages/listAdapt/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'pagesWaterfall',
                        component: () => import('@renderer/views/pages/waterfall/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/steps',
                        name: 'pagesSteps',
                        component: () => import('@renderer/views/pages/steps/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/preview',
                        name: 'pagesPreview',
                        component: () => import('@renderer/views/pages/preview/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/waves',
                        name: 'pagesWaves',
                        component: () => import('@renderer/views/pages/waves/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/tree',
                        name: 'pagesTree',
                        component: () => import('@renderer/views/pages/tree/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/drag',
                        name: 'pagesDrag',
                        component: () => import('@renderer/views/pages/drag/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/lazyImg',
                        name: 'pagesLazyImg',
                        component: () => import('@renderer/views/pages/lazyImg/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () => import('@renderer/views/pages/dynamicForm/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/pages/workflow',
                        name: 'pagesWorkflow',
                        component: () => import('@renderer/views/pages/workflow/index.vue'),
                        meta: {
                ...
                children: [
                    {
                        path: '/make/selector',
                        name: 'makeSelector',
                        component: () => import('@renderer/views/make/selector/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/make/noticeBar',
                        name: 'makeNoticeBar',
                        component: () => import('@renderer/views/make/noticeBar/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/make/svgDemo',
                        name: 'makeSvgDemo',
                        component: () => import('@renderer/views/make/svgDemo/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/make/tableDemo',
                        name: 'makeTableDemo',
                        component: () => import('@renderer/views/make/tableDemo/index.vue'),
                        meta: {
                ...
                children: [
                    {
                        path: '/params/common',
                        name: 'paramsCommon',
                        component: () => import('@renderer/views/params/common/index.vue'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () => import('@renderer/views/params/common/details.vue'),
                        meta: {
                    ...
                    },
                    {
                        path: '/params/dynamic',
                        name: 'paramsDynamic',
                        component: () => import('@renderer/views/params/dynamic/index.vue'),
                        meta: {
                     ...
                     */
                    {
                        ...
                        component: () => import('@renderer/views/params/dynamic/details.vue'),
                        meta: {
            ...
            },
            {
                ...
                /**
                 * 打开内置全屏
                 * component 都为 `() => import('@renderer/layout/routerView/link.vue')`
                ...
                children: [
                    {
                        ...
                        component: () => import('@renderer/layout/routerView/link.vue'),
                        meta: {
            ...
            },
            {
                path: '/chart',
                name: 'chartIndex',
                component: () => import('@renderer/views/chart/index.vue'),
                meta: {
...
export const staticRoutes: Array<RouteRecordRaw> = [
     ...
     */
    {
        ...
        component: () => import('@renderer/views/visualizing/demo1.vue'),
        meta: {
            title: 'message.router.visualizingLinkDemo1',
        },
    },
    {
        ...
        component: () => import('@renderer/views/visualizing/demo2.vue'),
        meta: {
            title: 'message.router.visualizingLinkDemo2',
        },
    },
